  ...
  pt: {
    translation: {
      ...
      contact: {
        ...
        form_business: "Assunto",
        form_business_ph: "Insira o motivo de contato",
        send: "Enviar",
        service: "Atendimento",
      },
      construction: {
  ...
  fr: {
    translation: {
      ...
      contact: {
        ...
        form_business: "Raison de contact",
        form_business_ph: "Entrez votre raison de contact",
        send: "Envoyer",
        service: "Service",
      },
      construction: {
  ...
  de: {
    translation: {
      ...
      contact: {
        ...
        form_business: "Grund des Kontakts",
        form_business_ph: "Kontaktgrund eingeben",
        send: "Senden",
        service: "Dienst",
      },
      construction: {
  ...
  es: {
    translation: {
      ...
      contact: {
        ...
        form_business: "Motivo del contacto",
